    ...
    <table class="table" style="width: 50%;">
        ...
        <tbody>
            ...
            if (isset($_GET['del'])) {
                ...
                $dels = mysqli_query($con,"DELETE from `players` where id = '".$_GET['del_id']."'");
            }
            ...
            $quy = mysqli_query($con,"SELECT * FROM `players`") or die("error" . mysqli_error($con));
            ...
            ?>
                <tr>
                    ...
                    <td><a href="player_delete_admin.php?del&del_id=<?php echo $li['id'] ?>" class="btn btn-danger">Delete</a></td>
